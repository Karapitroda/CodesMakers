...
/*
    ...
    @Override
    public void openVerificationDialog(String mobileNumber, VerifyCodeCallback listener) {
        final BaseActivity baseActivity = getBaseActivity();
        baseActivity.openVerificationDialog(mobileNumber, listener);
    }


    @Override
    public void openAgreementDialog(PermissionsCallback listener) {
        final BaseActivity baseActivity = getBaseActivity();
        baseActivity.openAgreementDialog(listener);
    }
*/
